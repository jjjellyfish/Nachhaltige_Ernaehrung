...
```{r functions}
rsquared_aov <- function(aov_result) {
...
model0 <- paste("score_v1 ~ ", kov_string)

anv0 <-  aov(eval(parse(text = model0)), data=v2)
#summary(anv0)
rsquared_aov(anv0)
...
anv1 <-  aov(eval(parse(text = model)), data=v2)
#summary(anv1)
rsquared_aov(anv1)
