...
v1 <- tmp %>% 
  select(lfdn, v_321, v_325, v_329, v_330, v_331, v_332, v_334, v_335, v_346, v_347, v_348, v_349, v_350, v_351, v_359, v_360, v_364, v_365, ern_erw, ern_kid) %>% 
  mutate(score_v1=rowSums(select(., 2:length(.)), na.rm=TRUE)/(length(.)-1))
